...
(function () {
  ...
  $(function () {
    ...
    function setSwiperNavPreview(swiper) {
      ...
      slidesCount = swiper.slides.filter(function (el) {
    ...
    function liveSearch(options) {
      $("#" + options.live).removeClass("cleared")();
      options.current++;
    ...
    function validateReCaptcha(captcha) {
      ...
      if (captchaToken.length === 0) {
        captcha
          .siblings(".form-validation")("Please, prove that you are not robot.")
          .addClass("active");
        ...
        captcha.on("propertychange", function () {
          ...
          if (captchaToken.length > 0) {
            ...
            $this.siblings(".form-validation").removeClass("active")("");
                    ...
                    if (clearHandler === false) {
                      ...
                      $body.on("click", function (e) {
                        if ($(e.toElement).parents(".rd-search").length === 0) {
                          $("#rd-search-results-live").addClass("cleared")("");
                        }
                      });
                    }
                  } else if (this.term.length === 0) {
                    $("#" + this.live).addClass("cleared")("");
                  }
                },
                options,
                this
      ...
      for (let i = 0; i < plugins.swiper.length; i++) {
        let node = plugins.swiper[i],
          ...
          pagination = customContainer
            ? customContainer.querySelector(".swiper-pagination")
            : node.querySelector(".swiper-pagination"),
          ...
          defaults = {
            ...
            autoplay: {
              ...
              delay: !isNaN(Number(node.getAttribute("data-autoplay")))
                ? node.getAttribute("data-autoplay")
                : 5000,
            },
        ...
        params.on = {
            ...
            if (swiperCustomIndex && swiperCustomCount) {
              ...
              if (swiperCustomCount) {
                swiperCustomCount.innerHTML = formatIndex(
                  $(this.slides).not(".swiper-slide-duplicate").length
                );
              }
            }
          ...
          slideChangeTransitionStart: function () {
            ...
            if (
              $(this.slides)[activeSlideIndex - 1].getAttribute(
                "data-slide-title"
              )
            ) {
              $(this.container).find(
                ".swiper-button-next .title"
              )[0].innerHTML = $(this.slides)[
                activeSlideIndex + 1
            ...
            if (
              ...
              $(this.container).find(
                ...
                activeSlideIndex - 1
              ].getAttribute("data-slide-subtitle");
              $(this.container).find(
            ...
            function ($email, event) {
              ...
              $.ajax({
                ...
                success: function (resp) {
                  $output(resp.msg).addClass("active");
                  $email[0].value = "";
                ...
                beforeSend: function (data) {
                  ...
                  $output("Submitting...").addClass("active");
                },
              });
        ...
        $campaignItem.on(
          ...
          $.proxy(function (e) {
            ...
            $.ajax({
              ...
              success: function (resp) {
                $output(resp.Message).addClass("active");
                ...
                $.ajax({
                  ...
                  if (responceCode !== "CPT000") {
                    if (output.hasClass("snackbars")) {
                      ...
                      output(captchaMsg[responceCode]);
                    }
        ...
        if ($slickItem.attr("data-fraction")) {
          (function () {
            ...
            $slickItem.on("afterChange", function (slick) {
              fractionCurrent.innerText = leadingZero(
                this.slick.currentSlide + 1
              );
